    ...
    <section class="book_section layout_padding">
        ...
        <div class="row">
            ...
            <div class="form_container d-flex justify-content-center align-items-center">
                ...
                <div>
                    <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus placeholder="Ingrese su número de celular">
